...
<li><div class="dropdown">
  ...
  <div class="dropdown-content">
   ...
   <div class="container thumbs">
      <center> <div class="col-sm-12 col-md-12">
        <div class="thumbnail">
...
<form action="" method="post">
 <center><h1><strong>Student information</strong></h1><table border="1">
...
<th><strong>Busstop</strong></th>
<th><strong>FeesPaid</strong></th>
...
{
$sel=mysql_query("select * from reg where routeno=".$_POST['no']."");
...
<td><a href="dataup.php?rno=<?=$row[0]?>">Edit</a></td> 
<td><a href="datadel.php?rno=<?=$row[0]?>">Delete</a></td></tr>
 <?php
 }
 }
 ?>
 ...
 <center>
 <a href="adminhome.php"><strong>Back</strong></a></center></html>
