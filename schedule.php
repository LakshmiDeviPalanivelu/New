...
</style><table border="1"><div class="ad">
<form action="" method="post">
<h2>Add Bus Stop Form</h2>
<center><table><strong>
<tr><td>RouteNo</td><td><input type="text" name="rno"></td></tr>
<tr><td>StopName</td><td><input type="text" name="sname"></td></tr>
<tr><td>Time</td><td><input type="text" name="time"></td></tr>
<tr><td>Fees</td><td><input type="text" name="fee"></td></tr>
...
{
$ins=mysql_query("insert into bus (routeno,stopname,time,fees)values(".$_POST['rno'].",'".$_POST['sname']."','".$_POST['time']."',".$_POST['fee'].")",$con);
//echo "insert into bus (routeno,stopname,time)values(".$_POST['rno'].",'".$_POST['sname']."','".$_POST['time']."')";
}
