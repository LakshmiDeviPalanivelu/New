  ...
  <body>
   ...
   <div class="container thumbs">
      <center> <div class="col-sm-10 col-md-12">
        <div class="thumbnail">
          <img src="img/b15.jpg" alt="" class="img-responsive">
          <div class="caption">
   <html>
 <table>
 <form action="dataretrivel.php" method="post">
 <tr><td><strong>Enter the bus Route No</strong></td><td><input type="text" name="no"></td><tr>
