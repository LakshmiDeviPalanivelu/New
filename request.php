...
<h2>Student Request Deatils</h2>
 <center><table border="1">
 <th><strong>Requestno</strong></th>
<th><strong>StudentId</strong></th>
<th><strong>Request Root</strong></th>

<?php
$sel=mysql_query("select * from request ",$con);
...
<tr><td><strong>Request Root</strong><td><textarea id="com" name="com"></textarea></td></tr>
...
{
$ins=mysql_query("insert into srequest (studentid,request)values(".$_POST['name'].",'".$_POST['com']."')",$con);
}
?>
    ...
    </div><a href="adminhome.php"><strong>BACK</strong></a></center></center><!-- End Thumbnails -->
