...
<tr><td><strong>Feedback</strong><td><textarea id="com" name="com"></textarea></td></tr>
...
{
$ins=mysql_query("insert into feedback (sid,feedback)values(".$_POST['name'].",'".$_POST['com']."')",$con);
}
